...
const RightSide = () => {
  return (
    <div className="w-full no-scroll-bar lg:pt-8 px-2 overflow-y-scroll no-scrollbar right-menu">
            ...
            <div className="mx-auto w-full md:max-w-6xl text-gray-500">
              <div className="grid gap-3">
                ...
                {data.experience.map((exp, index) => {
                  return (
                    <div className="relative group overflow-hidden p-4 md:p-8 rounded-xl border border-gray-800 bg-primary w-full">
                      <div
                        aria-hidden="true"
      ...
      <div className="pe-16 text-gray-400 py-8" id="skills">
        <h3 className="text-2xl font-bold capitalize text-[#c4d0ec] hover:text-[#54d2d4] cursor-pointer">
          my skills
        </h3>
          ...
          <div>
            <div className="mx-auto max-w-6xl text-gray-500">
              <div className="grid  sm:grid-cols-1 gap-3 md:grid-cols-1 text-thirdly">
                {/*  */}
                Frontend
                <div className="relative group overflow-hidden lg:px-8  p-4 rounded-xl border  border-gray-800 bg-primary grid gap-y-3 grid-cols-4 gap-x-3 md:grid-cols-5 lg:grid-cp">
                  <div
                    aria-hidden="true"
                  ...
                  {data.technologies["front-end"].map((tech, index) => {
                    return (
                      <div className="bg-slate-800 start-16 border border-white/15 w-fit p-4 rounded-xl before:shadow-gray-950 ">
                ...
                Backend
                <div className="relative group overflow-hidden lg:px-8  p-4 rounded-xl border  border-gray-800 bg-primary grid gap-y-3 grid-cols-4 gap-x-3 md:grid-cols-6">
                  <div
                    aria-hidden="true"
                    className="inset-0 absolute border rounded-full -translate-y-1/2 group-hover:-translate-y-1/4 duration-300 bg-gradient-to-b from-white to-white blur-2xl opacity-5 group-hover:opacity-10"
                  />
      ...
      {/*  */}
      {/*  */}
      <div className="pe-16 text-gray-400 py-8" id="projects">
        <h3 className="text-2xl font-bold capitalize text-[#c4d0ec] hover:text-[#54d2d4] cursor-pointer">
          my projects
        </h3>
        <section className="relative top-4">
            ...
            <div className="mx-auto max-w-6xl text-gray-500">
              <div className="grid gap-3">
                ...
                {data.projects.map((prd, index) => {
                  return (
                    <div className="relative group overflow-hidden p-8 rounded-xl border  border-gray-800 bg-primary">
                      <div
                        aria-hidden="true"
                        className="inset-0 absolute aspect-video border rounded-full -translate-y-1/2 group-hover:-translate-y-1/4 duration-300 bg-gradient-to-b from-blue-500 to-white dark:from-white dark:to-white blur-2xl opacity-25 dark:opacity-5 dark:group-hover:opacity-10"
                      />
                      <div className="flex gap-x-6 min-h-32 items-center">
                        ...
                        <div className="relative">
                          ...
                          <div className="mt-2 pb-2">
                            <p className="text-gray-400 group-hover:text-gray-300 text-xs max-w-[75%] md:max-w-auto">
                              {prd.description}
                            </p>
                          </div>
                          <div className="flex gap-3 -mb-8 py-4 border-t border-gray-200 dark:border-gray-800">
